...
<br/>
<p align="center">Complete coursera courses in just <strong>one click</strong>. Now no need to waste your valuable time in watching those nonsense videos and attempting quiz</p>
<br/>    
...
> [!NOTE]
> The Auto Quiz/AI answers require you to enter Gemini API key. Get a key by cliking [here](https://aistudio.google.com/apikey)

![image](https://github.com/user-attachments/assets/645db172-ff44-4a01-a436-1218a5dc1974)

## 🧑‍💻 Usage
When on the course page, where all the moduels are shown in the left sidebar. Click 'Byapss course' and wait for the extension to complete the course. After that, reload the page.

Similerly, while on the quiz (opened) you can click 'Solve Quiz' button to automatically select the correct option. NOTE, this only works only and only on single choise questions (MCQ)


## 🔑 Getting API key
Getting a gemini API key is as simple as cooking a maggie!
